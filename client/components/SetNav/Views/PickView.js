...
export default function PickView({ view, setView, loggedIn }) {
  ...
  return (
    <div
      ...
      } transition transform duration-500 my-6 md:my-8 xl:mt-12 flex flex-col bg-app-gray`}
    >
      <div className="mx-auto w-full">
        <button
          onClick={setsButtonClick}
          className="text-2xl md:text-2xl lg:text-4xl my-3 text-app-green py-6 px-12 rounded-2xl shadow-xl mx-auto bg-app-dark-blue focus:outline-none hover:opacity-75 transition duration-300"
        >
